...
<html lang="en">
  <head>
    ...
    function menu_over(e){
    	e.setAttribution("class", "nav item active"); // <li class="nav item active">
    }
    function menu_out(e){
    	e.setAttribution("class", "nav item"); // <li class="nav item active">
    }
    </script>
    <style>
    div.container{
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<div class="container"><h1>Hello, Bootstrap!</h1>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta/js/bootstrap.min.js" integrity="sha384-h0AbiXch4ZDo7tp9hKZ4TsHbi047NrKGLO3SEJAg45jXxnGIfYzk4Si90RDIqNm1" crossorigin="anonymous"></script>
  	...
  	$(document).ready(function(){
  		$('#loginform').submit(function(event) {
  			...
  			// ìë²ë¡ post ë°©ì ì ì¡
  			$.post("/WebClass/login", {id : id, pwd: pwd}, function(data){
  				//ìë²ë¡ë¶í°ì ìëµ
